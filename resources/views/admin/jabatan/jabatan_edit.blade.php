        ...
        <div class="col-lg-12">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <form action="{{ route('admin.jabatan_edit_proses', $jabatan->id ) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="nama" class="form-control text-dark ps-5 h-58" value="{{ $jabatan->nama }}"
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="level" class="form-control text-dark ps-5 h-58" value="{{ $jabatan->level }}"
                                            placeholder="Tentukan Tingkatan" required>
                                        <i
                                            class="ri-hashtag position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                    </div>
                                </div>
